  ...
  return (
    <section className="max-w-6xl mx-auto p-6 py-35">
      <div className="text-center mb-24">
        <h2 className="text-4xl font-bold mb-4 text-gray-900 tracking-tight">Contacta con nosotros</h2>
        <p className="text-gray-500 text-lg mb-12">Estamos a tu disposición para cualquier consulta.</p>

        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          <div className="flex flex-col items-center justify-center h-[72px] px-8 bg-white border border-gray-200 rounded-xl w-full md:w-auto">
            <span className="text-[10px] uppercase tracking-[0.2em] text-gray-400 font-semibold leading-none mb-1">Llámanos</span>
            <a href={`tel:${dataContact.number}`} className="text-xl font-bold text-gray-900 hover:text-emerald-700 transition-colors">
              +{number}
            </a>
          </div>
      ...
      <h2 className="text-3xl font-bold mb-12 text-center text-gray-900 tracking-tight">Preguntas Frecuentes</h2>
